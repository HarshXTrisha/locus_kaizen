...
export function Sidebar() {
  ...
  return (
    <div className={`hidden lg:flex lg:flex-col lg:fixed lg:inset-y-0 lg:z-50 lg:bg-gradient-to-b from-white to-gray-50 lg:border-r lg:border-gray-200 lg:shadow-lg transition-all duration-300 ${
