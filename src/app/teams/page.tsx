    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Teams Coming Soon</h2>
          <p className="text-gray-600 mb-6">Team collaboration features will be available soon.</p>
          <button
