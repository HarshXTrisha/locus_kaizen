...
const serviceAccount = {
  ...
  project_id: process.env.FIREBASE_PROJECT_ID || "locus-8b4e8",
  private_key_id: process.env.FIREBASE_PRIVATE_KEY_ID || "2096cdc34633b5f4ffb7ae503a23385f1ff06991",
  ...
  client_email: process.env.FIREBASE_CLIENT_EMAIL || "firebase-adminsdk-fbsvc@locus-8b4e8.iam.gserviceaccount.com",
  client_id: "100615687343500852757",
  auth_uri: "https://accounts.google.com/o/oauth2/auth",
  token_uri: "https://oauth2.googleapis.com/token",
  auth_provider_x509_cert_url: "https://www.googleapis.com/oauth2/v1/certs",
  client_x509_cert_url: "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40locus-8b4e8.iam.gserviceaccount.com",
